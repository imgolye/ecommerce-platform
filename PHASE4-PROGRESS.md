...
**任务组2: 商品管理（已完成）** ✅
1. ✅ GoodsServiceImpl.java
2. ✅ GoodsController.java
3. ✅ SKU Entity（3个）
4. ✅ SKU Mapper（3个）
5. ✅ SKU Service（3个）
6. ✅ SKU ServiceImpl（1个）
7. ✅ SKU Controller（1个）
